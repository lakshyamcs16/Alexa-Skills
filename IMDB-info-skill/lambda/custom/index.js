...
const APP_ID = 'ID';  // TODO replace with your app ID (OPTIONAL).


let data = '';
var speech = "You didn't say anything";
var name = "", rating = '';
var year = null;
var movieTitle = '';
var whichIntent = 1;
    ...
    'GetMovieInfo': function () {
        ...
        if (this.event.request.intent.slots.movieName.value) {
            name = this.event.request.intent.slots.movieName.value;
                ...
                http.get('http://www.omdbapi.com/?apikey=Your%20Key%20Here='+name+'&plot=full', (resp) => {
                    ...
                    resp.on('end', () => {
                                ...
                                if(speech.Title === undefined) {
                                    say = this.t('SORRY_MESSAGE');
